...
%A Dung's argumentation framework is based on logical theory which is transformed to arguments and a binary attack relation. This limitation causes these frameworks to be incapable to express attacks on attacks in an easy way. As this is required to extend basic argumentation frameworks with a representation of defeasible preferences between arguments an extension to these frameworks will be presented in the following section.
...
Hence, a brief introduction to the definition of \glspl{EAF} is presented in the following section.
\begin{figure}[b!]
\centering
