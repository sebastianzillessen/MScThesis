...
\begin{figure}[tbp]
	...
	\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2cm,
	  ...
	  \path[every node/.style={font=\sffamily\small}]
	   ...
	   ;
	\end{tikzpicture}
	\caption{\gls{EAF} about the weather forecasts with preferences over arguments. Dashed attacks are cancelled out. Double-arrow-headed edges represent attacks on attacks. Green nodes represent accepted arguments in the unique preferred extension.}
	\label{fig:eaf_intro}
\end{figure}
