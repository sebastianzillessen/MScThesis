...
\todo{Make sure your use of capital letter is consistent throughout the document.}
\todo{Some parts of the text are in italic.  Why is this? If you are quoting text, you should surround the quoted text by quotation marks and cite the source.}
...
\begin{definition}
\todo{add an intuitive explanation of why conflict free sets of arguments are of interest.}
...
\begin{definition}
\todo{Definition 2.4: add an intuitive explanation of what the concept of an "acceptable argument" models}
...
\begin{exa}
\todo{Example 2.3: Rephrase in terms of "acceptable argument" or state what it means for one argument to defend another.}
...
\begin{definition}
\todo{Definition 2.8: "each argument, which is acceptable" --> "each argument that is acceptable".  Also, add an intuitive explanation of a complete extension.
}
...
\begin{remark}
\todo{Remark 2.10: This is good, but it does not cover the fact that a grounded extension is minimal.}
...
\todo{Remark 2.13: Good summary, but add a source.}
\begin{itemize} 
...
\begin{exa}
\todo{Example 2.9: "the preferred semantic": should this not be "a preferred semantic"?}
