...
\begin{definition}
	A conflict-free set $S' \subseteq \S$ is \textbf{admissible} iff $S'$ defends all of its arguments (\textit{each argument in $S'$ is acceptable with respect to $S'$}) \tbd{ or $S' \subseteq F_{AF}(S')$}.
\end{definition}
...
\todo{This could be left out from my point of view, as it is not relevant to the remaining dissertation}
\tbd{
	\begin{definition}	
