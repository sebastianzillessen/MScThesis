...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=1cm,
  ...
  \path[every node/.style={font=\sffamily\small}]
    ...
    ;
\end{tikzpicture}
\caption{Example of a \gls{SKB}. Green coloured assumptions hold while red coloured assumptions do not hold. Green coloured models are the possible models after \autoref{as:1}}
...
\begin{figure}[!h]
	...
	\hfill
	\subfigure[0.45\textwidth][Next \gls{CD} applied: $CD2_{predict}$ holds. The attack $(m_1,m_2)$ is canceled out. $m_1$ is not acceptable w.r.t $\S_2'' = \{CD1_{light}, CD2_{predict}\}$. The recommended model is $m_2$.]{
	  	\begin{minipage}{0.45\textwidth}
	  		\centering
