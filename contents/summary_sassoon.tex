...
The foundation of this MSc Project is the paper \cite{sassoon2014}. The following papers of Sassoon \textit{et al.} \cite{sassoon2016,sassoon2016CD} have been taken into account, as they provide an elegant solution to express the order of preferences in different \glspl{CD}.
...
\todo{Rephrase next paragraph: I would rephrase it and focus on clinicians needing help in selecting the model once the data is available}
...
\subsubsection{Adding Preferences for different Context Domains to the \gls{SKB}}
...
During this process the \glspl{CD} that relate to statistical theory are regarded as more important than clinician preferences. This is reflected in the final web application by reserving the priorities 1 - 9 to the statistician only (1 has the highest priority). Clinicians can express their personal preferences in \glspl{CD} with a priority lower than or equal to 10. 
