...
\newglossaryentry{integration_test}{
	...
	description={ Individual software modules are combined and tested as a group to check whether a desired feature is implemented correctly. Usually two to four components are tested together}
}
\newglossaryentry{e2e_test}{
	name={end-to-end test},
	description={Tests whether the flow of an application is behaving as expected. End-to-end tests ensure data integrity and usability if of an application}
}
